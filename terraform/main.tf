...
resource "google_cloud_run_service" "iprprotection" {
  provider = google-beta
  name     = "iprprotection"
  location = var.gcp_region
  project  = var.project_id
...
resource "google_cloud_run_service_iam_policy" "all_users_policy" {
  location    = google_cloud_run_service.iprprotection.location
  project     = google_cloud_run_service.iprprotection.project
  service     = google_cloud_run_service.iprprotection.name
